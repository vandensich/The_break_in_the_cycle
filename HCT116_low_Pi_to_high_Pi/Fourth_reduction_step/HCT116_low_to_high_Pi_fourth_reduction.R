...
flist_O <- NULL %>% 
  ...
  addReaction("InsP8"          ,"InsP71"   , "k8") %>%
  addReaction("InsP8_1O_10O51O","InsP71"   , "k8") %>%
  addReaction("InsP8_2O_10O52O","InsP71"   , "k8") %>%
  addReaction("InsP8_3O_10O53O","InsP71"   , "k8") %>%
  
  addReaction("InsP8_1O_11O50O","InsP71_1O", "k8") %>%
  addReaction("InsP8_2O_11O51O","InsP71_1O", "k8") %>%
  addReaction("InsP8_3O_11O52O","InsP71_1O", "k8") %>%
  addReaction("InsP8_4O_11O53O","InsP71_1O", "k8") %>%
  
  addReaction("InsP8_2O_12O50O","InsP71_2O", "k8") %>%
  addReaction("InsP8_3O_12O51O","InsP71_2O", "k8") %>%
  addReaction("InsP8_4O_12O52O","InsP71_2O", "k8") %>%
  addReaction("InsP8_5O_12O53O","InsP71_2O", "k8") %>%
  
  addReaction("InsP8_3O_13O50O","InsP71_3O", "k8") %>%
  addReaction("InsP8_4O_13O51O","InsP71_3O", "k8") %>%
  addReaction("InsP8_5O_13O52O","InsP71_3O", "k8") %>%
  addReaction("InsP8_6O"       ,"InsP71_3O", "k8") %>%
...
out_mstrust_o <- mstrust(obj_o, pouter, studyname = "HCT116_low_to_high_pi_fourth_reduction_fits",rinit = 1, rmax = 10, iterlim = 2000,
...
save(myframe_o, file = "Results_HCT116_low_to_high_pi_fourth_reduction.RData")

p1 <-plotValues(myframe_o, tol = 0.01, value<=2000)
ggsave("Waterfall_HCT116_low_to_high_pi_fourth_reduction.pdf",p1, height = 8,width = 10)

bestfit_o <- as.parvec(myframe_o)
save(bestfit_o, file = "bestfit_HCT116_low_to_high_pi_fourth_reduction.RData")
...
ggsave("Bestfit_HCT116_low_to_high_pi_fourth_reduction.pdf",p2, height = 8,width = 10)
...
ggsave("Bestfit_HCT116_low_to_high_pi_fourth_reduction_only_fitted.pdf",p3, height = 8,width = 10)
...
save(profiles_o, file = "Profiles_HCT116_low_to_high_pi_fourth_reduction.RData")
load(file = "Profiles_HCT116_low_to_high_pi_fourth_reduction.RData")
print("Profiles done")
...
ggsave("Profiles_HCT116_low_to_high_pi_fourth_reduction.pdf",p8, height = 10,width = 12)
