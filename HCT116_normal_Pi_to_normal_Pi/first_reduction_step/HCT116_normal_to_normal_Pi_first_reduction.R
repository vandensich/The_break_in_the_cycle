...
out_mstrust_o <- mstrust(obj_o, pouter, studyname = "HCT116_normal_to_normal_pi_first_reduction_fits",rinit = 1, rmax = 10, iterlim = 2000,
...
save(myframe_o, file = "Results_HCT116_normal_to_normal_pi_first_reduction.RData")

p1 <-plotValues(myframe_o, tol = 0.01, value<=2000)
ggsave("Waterfall_HCT116_normal_to_normal_pi_first_reduction.pdf",p1, height = 8,width = 10)

bestfit_o <- as.parvec(myframe_o)
save(bestfit_o, file = "bestfit_HCT116_normal_to_normal_pi_first_reduction.RData")
...
ggsave("Bestfit_HCT116_normal_to_normal_pi_first_reduction.pdf",p2, height = 8,width = 10)
...
ggsave("Bestfit_HCT116_normal_to_normal_pi_first_reduction_only_fitted.pdf",p3, height = 8,width = 10)
...
save(profiles_o, file = "Profiles_HCT116_normal_to_normal_pi_first_reduction.RData")
load(file = "Profiles_HCT116_normal_to_normal_pi_first_reduction.RData")
print("Profiles done")
...
ggsave("Profiles_HCT116_normal_to_normal_pi_first_reduction.pdf",p8, height = 10,width = 12)
